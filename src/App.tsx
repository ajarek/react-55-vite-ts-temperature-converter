...
function App() {
  ...
  const changeValue=(e:any)=>{
    ...
    setDisplayFar(far)
    setDisplayKel(kel)
    setCelsius(celsius=>celsius=universal)
    setFahrenheit(fahrenheit=>fahrenheit=universal)
    setKelvin(kelvin=>kelvin=universal)}
   
   }
  
  return (
    <div className="App">
      <AppContext.Provider value={{ kelvin, setKelvin, celsius, setCelsius,fahrenheit, setFahrenheit, displayCel, setDisplayCel ,displayFar,setDisplayFar, displayKel,setDisplayKel }}>
